...
type AddressEvents struct {
	...
	NodeOperatorRewardAddressChangeProposed  []CsmoduleNodeOperatorRewardAddressChangeProposed  `json:"nodeOperatorRewardAddressChangeProposed"`
	NodeOperatorManagerAddressChangeProposed []CsmoduleNodeOperatorManagerAddressChangeProposed `json:"nodeOperatorManagerAddressChangeProposed"`
}

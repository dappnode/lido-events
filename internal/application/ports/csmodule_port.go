...
type CsModulePort interface {
	...
	ScanWithdrawalSubmitted(ctx context.Context, handleWithdrawalSubmitted func(*domain.CsmoduleWithdrawalSubmitted, *big.Int) error) error
	ScanElRewardsStealingPenaltyReported(ctx context.Context, handleElRewardsStealingPenaltyReported func(*domain.CsmoduleELRewardsStealingPenaltyReported, *big.Int) error) error

...
func (fs *Storage) GetLidoReport(start, end string) (map[string]domain.Report, error) {
...
func (fs *Storage) SaveLidoReport(report map[string]domain.Report) error {

...
func (_Bindings *BindingsCaller) DistributedShares(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "distributedShares", arg0)
...
//
// Solidity: function distributedShares(uint256 ) view returns(uint256)
func (_Bindings *BindingsSession) DistributedShares(arg0 *big.Int) (*big.Int, error) {
	return _Bindings.Contract.DistributedShares(&_Bindings.CallOpts, arg0)
}

// DistributedShares is a free data retrieval call binding the contract method 0xea6301ab.
//
// Solidity: function distributedShares(uint256 ) view returns(uint256)
func (_Bindings *BindingsCallerSession) DistributedShares(arg0 *big.Int) (*big.Int, error) {
	return _Bindings.Contract.DistributedShares(&_Bindings.CallOpts, arg0)
}
...
func (_Bindings *BindingsCaller) GetFeesToDistribute(opts *bind.CallOpts, nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*big.Int, error) {
	var out []interface{}
	err := _Bindings.contract.Call(opts, &out, "getFeesToDistribute", nodeOperatorId, shares, proof)
...
//
// Solidity: function getFeesToDistribute(uint256 nodeOperatorId, uint256 shares, bytes32[] proof) view returns(uint256 sharesToDistribute)
func (_Bindings *BindingsSession) GetFeesToDistribute(nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*big.Int, error) {
	return _Bindings.Contract.GetFeesToDistribute(&_Bindings.CallOpts, nodeOperatorId, shares, proof)
}

// GetFeesToDistribute is a free data retrieval call binding the contract method 0x5e8e8f6f.
//
// Solidity: function getFeesToDistribute(uint256 nodeOperatorId, uint256 shares, bytes32[] proof) view returns(uint256 sharesToDistribute)
func (_Bindings *BindingsCallerSession) GetFeesToDistribute(nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*big.Int, error) {
	return _Bindings.Contract.GetFeesToDistribute(&_Bindings.CallOpts, nodeOperatorId, shares, proof)
}
...
func (_Bindings *BindingsTransactor) DistributeFees(opts *bind.TransactOpts, nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "distributeFees", nodeOperatorId, shares, proof)
}

// DistributeFees is a paid mutator transaction binding the contract method 0x21893f7b.
//
// Solidity: function distributeFees(uint256 nodeOperatorId, uint256 shares, bytes32[] proof) returns(uint256 sharesToDistribute)
func (_Bindings *BindingsSession) DistributeFees(nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*types.Transaction, error) {
	return _Bindings.Contract.DistributeFees(&_Bindings.TransactOpts, nodeOperatorId, shares, proof)
}

// DistributeFees is a paid mutator transaction binding the contract method 0x21893f7b.
//
// Solidity: function distributeFees(uint256 nodeOperatorId, uint256 shares, bytes32[] proof) returns(uint256 sharesToDistribute)
func (_Bindings *BindingsTransactorSession) DistributeFees(nodeOperatorId *big.Int, shares *big.Int, proof [][32]byte) (*types.Transaction, error) {
	return _Bindings.Contract.DistributeFees(&_Bindings.TransactOpts, nodeOperatorId, shares, proof)
}
...
func (_Bindings *BindingsTransactor) Initialize(opts *bind.TransactOpts, admin common.Address) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "initialize", admin)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address admin) returns()
func (_Bindings *BindingsSession) Initialize(admin common.Address) (*types.Transaction, error) {
	return _Bindings.Contract.Initialize(&_Bindings.TransactOpts, admin)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address admin) returns()
func (_Bindings *BindingsTransactorSession) Initialize(admin common.Address) (*types.Transaction, error) {
	return _Bindings.Contract.Initialize(&_Bindings.TransactOpts, admin)
}

// ProcessOracleReport is a paid mutator transaction binding the contract method 0x7fb388fb.
//
// Solidity: function processOracleReport(bytes32 _treeRoot, string _treeCid, string _logCid, uint256 distributed) returns()
func (_Bindings *BindingsTransactor) ProcessOracleReport(opts *bind.TransactOpts, _treeRoot [32]byte, _treeCid string, _logCid string, distributed *big.Int) (*types.Transaction, error) {
	return _Bindings.contract.Transact(opts, "processOracleReport", _treeRoot, _treeCid, _logCid, distributed)
}

// ProcessOracleReport is a paid mutator transaction binding the contract method 0x7fb388fb.
//
// Solidity: function processOracleReport(bytes32 _treeRoot, string _treeCid, string _logCid, uint256 distributed) returns()
func (_Bindings *BindingsSession) ProcessOracleReport(_treeRoot [32]byte, _treeCid string, _logCid string, distributed *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.ProcessOracleReport(&_Bindings.TransactOpts, _treeRoot, _treeCid, _logCid, distributed)
}

// ProcessOracleReport is a paid mutator transaction binding the contract method 0x7fb388fb.
//
// Solidity: function processOracleReport(bytes32 _treeRoot, string _treeCid, string _logCid, uint256 distributed) returns()
func (_Bindings *BindingsTransactorSession) ProcessOracleReport(_treeRoot [32]byte, _treeCid string, _logCid string, distributed *big.Int) (*types.Transaction, error) {
	return _Bindings.Contract.ProcessOracleReport(&_Bindings.TransactOpts, _treeRoot, _treeCid, _logCid, distributed)
}
...
type BindingsDistributionLogUpdatedIterator struct {
	Event *domain.BindingsDistributionLogUpdated // Event containing the contract specifics and raw log
...
func (it *BindingsDistributionLogUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(domain.BindingsDistributionLogUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
//
// Solidity: event DistributionLogUpdated(string logCid)
func (_Bindings *BindingsFilterer) WatchDistributionLogUpdated(opts *bind.WatchOpts, sink chan<- *domain.BindingsDistributionLogUpdated) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(domain.BindingsDistributionLogUpdated)
...
//
// Solidity: event DistributionLogUpdated(string logCid)
func (_Bindings *BindingsFilterer) ParseDistributionLogUpdated(log types.Log) (*domain.BindingsDistributionLogUpdated, error) {
	event := new(domain.BindingsDistributionLogUpdated)
	if err := _Bindings.contract.UnpackLog(event, "DistributionLogUpdated", log); err != nil {
		return nil, err
	}
...
// BindingsFeeDistributedIterator is returned from FilterFeeDistributed and is used to iterate over the raw logs and unpacked data for FeeDistributed events raised by the Bindings contract.
type BindingsFeeDistributedIterator struct {
	Event *BindingsFeeDistributed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BindingsFeeDistributedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BindingsFeeDistributed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BindingsFeeDistributedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BindingsFeeDistributedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BindingsFeeDistributed represents a FeeDistributed event raised by the Bindings contract.
type BindingsFeeDistributed struct {
...
func (_Bindings *BindingsFilterer) FilterFeeDistributed(opts *bind.FilterOpts, nodeOperatorId []*big.Int) (*BindingsFeeDistributedIterator, error) {
	...
	logs, sub, err := _Bindings.contract.FilterLogs(opts, "FeeDistributed", nodeOperatorIdRule)
	if err != nil {
		return nil, err
	}
	return &BindingsFeeDistributedIterator{contract: _Bindings.contract, event: "FeeDistributed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event FeeDistributed(uint256 indexed nodeOperatorId, uint256 shares)
func (_Bindings *BindingsFilterer) WatchFeeDistributed(opts *bind.WatchOpts, sink chan<- *BindingsFeeDistributed, nodeOperatorId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Bindings.contract.WatchLogs(opts, "FeeDistributed", nodeOperatorIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BindingsFeeDistributed)
				if err := _Bindings.contract.UnpackLog(event, "FeeDistributed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event FeeDistributed(uint256 indexed nodeOperatorId, uint256 shares)
func (_Bindings *BindingsFilterer) ParseFeeDistributed(log types.Log) (*BindingsFeeDistributed, error) {
	event := new(BindingsFeeDistributed)
	if err := _Bindings.contract.UnpackLog(event, "FeeDistributed", log); err != nil {
		return nil, err
	}
